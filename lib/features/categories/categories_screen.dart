        ...
        builder: (controller) {
          return Obx(()=>Scaffold(
            ...
            body: (controller.isLoadingCategoryFinished &&
                    controller.isLoadingUserCategoryFinished)
                ? Container(
                    ...
                    child: SingleChildScrollView(
                      ...
                      children: [
                        ...
                        GridView.builder(
                            ...
                            primary: false,
                            shrinkWrap: true,
                            itemCount: controller.categoryFetchConverted.length,
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                onTap: () {
                                  controller.tapCategory(controller.categoryFetchConverted[index]);
                                },
                                child: LayoutBuilder(
